...
function uploadLocalFileToS3(filePath, url, { onProgress } = {}) {
    ...
    let putPromise;
    return (0, rest_client_utils_2.makeCancelablePromise)(() => __awaiter(this, void 0, void 0, function* () {
        if (isCanceled) {
            throw new rest_client_utils_1.CanceledPromiseError();
        }
        const { size: totalLength } = yield fs_1.promises.stat(filePath);
        if (isCanceled) {
            throw new rest_client_utils_1.CanceledPromiseError();
        }
        try {
            putPromise = got_1.default.put(url, {
                headers: {
                    'Content-Type': mime_types_1.default.lookup(filePath),
